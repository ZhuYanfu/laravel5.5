                    ...
                    <div class="ibox-content">
                        <form action = "{{ route('student.save') }}" class="form-horizontal m-t" method="POST" id="myForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="birthday" name="birthday" class="form-control" type="text" aria-required="true" aria-invalid="false" class="valid">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">性别：</label>
                                <div class="col-sm-8">
                                    <input  type="radio" id="gender_male" name="gender" checked="true" 
                                    value="1" />男  
